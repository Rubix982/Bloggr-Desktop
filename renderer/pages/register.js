...
export default function Register() {
  ...
  const registerUser = (event) => {
    ...
    if (Firstname == "" || Lastname == "" || Email == "" || Password == "") {
      ...
      axios
        .post("http://localhost:37606/api/register", formData)
        .then((response) => {
            ...
            <Container className={styles.containerSpacing}>
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      style={{ justifyContent: "center", paddingLeft: "5px" }}
                    >
                      <span className={styles.halfDivider}> </span>
                    </div>
                  </Grid>
                ...
                <Grid item style={{ paddingTop: "40px" }}>
                  <p className={styles.registerInfo}>
                    ...
                    <Link href="/login">
                      <a>
                        <span className={styles.linkToRegister}> Sign in</span>{" "}
                      </a>
                    </Link>
                  </p>
